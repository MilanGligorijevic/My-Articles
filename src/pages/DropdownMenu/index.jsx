...
import video1 from "../../assets/video/DropdownMenu1.mp4";
import video2 from "../../assets/video/DropdownMenu2.mp4";
import video3 from "../../assets/video/DropdownMenu3.mp4";
import video4 from "../../assets/video/DropdownMenu4.mp4";
    ...
    <PageLayout>
      <div className="flex flex-col gap-4">
        ...
        <p>
          ...
          this exact animation in a few of my projects already. It could work
          perfectly for mobile screen sizes but for a larger screens I knew I
...
function MenuButton({ toggleMenu }) {
  ...
  useEffect(() => {
    if (toggleMenu) {
      ...
      animate3(scope3.current, { rotateZ: -45, y: -6.25 }, { duration: 0.1 });
    } else {
...
`}
        ...
        <p>
          I decided to use my 3-bars-icon for a menu button since it aligned
          perfectly with the rest of the website but had to change its
          animation.
        </p>
        <p>
          My idea was to have 3-bars lowered and separated on a click. After
          that first animation the text would come in on each of the bars
          representing links to my Portfolio, GitHub and LinkedIn for example.
        </p>
        ...
        <HighlightField
          children={
            <>
              <div className="flex gap-2">
                <Arrow /> I changed animation in my initial code to go from
                rotating bars on Z axis to just changing their positions on Y
                axis
              </div>
            </>
          }
        />
        <p>
          Now when 3-bars animation is working all that's left is to make words
          animate down on the bars on Y axis. I used same principles for moving
          3-bars with some little adjustments of position and font sizes.
        </p>
        ...
        <HighlightField
          children={
            <>
              <div className="flex gap-2">
                <Arrow /> const [scope, word] = useAnimate()
              </div>
              <div className="flex gap-2">
                <Arrow /> Framer Motion useAnimate() was used for targeting each
                word and animating it
              </div>
            </>
          }
        />
        <p>
          After some testing and playing with design and animation I decided
          that words were not really going well with the rest of the website and
          they were hard to read.
        </p>
        <p>
          With that being said I swapped out words for icons of my Portfolio,
          GitHub and LinkedIn which in my opinion suited design better. After
          small adjustments and changes I got my final result.
        </p>
        ...
        <HighlightField
          children={
            <>
              <div className="flex gap-2">
                <Arrow /> Please note that component code is a bit longer due to
                all the SVGs used
              </div>
            </>
          }
